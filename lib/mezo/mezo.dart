...
class Mezo extends StatefulWidget {
  const Mezo({Key? key}) : super(key: key);

  @override
  _MezoState createState() => _MezoState();
}

class _MezoState extends State<Mezo> {
  ...
  Future<void> initPlugin() async {
    ...
    final serviceAccount = ServiceAccount.fromString(
        (await rootBundle.loadString('assets/credentials-fawazer.json')));
  ...
  void handlePredictions() async{
    if (kDebugMode) {
      print("فوازير");
    }
    handleSubmitted("فوازير");
  }
